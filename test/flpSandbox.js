		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Sap Fiori Netflix",
									"targetURL": "#netflixnetflix-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"netflixnetflix-display": {
								"semanticObject": "netflixnetflix",
								"action": "display",
								"description": "Sap Fiori Netflix",
								"title": "Sap Fiori Netflix",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=netflix.netflix",
									"url": sap.ui.require.toUrl("netflix/netflix")
								}
							}
						}
					}
